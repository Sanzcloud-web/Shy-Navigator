  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-12 z-40 py-2">
      <div className="h-full drag-region">
        ...
        <div className="absolute inset-y-0 left-1/2 -translate-x-1/2 flex items-center no-drag w-full max-w-md">
          <button
            onClick={onOpenPalette}
            className="w-full flex items-center gap-3 px-6 py-2 rounded-full bg-neutral-50 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700"
          >
            <Search className="w-4 h-4" />
            <span className="text-[15px] opacity-90">Rechercher ou entrer une URL…</span>
            <span className="ml-auto text-[11px] px-2 py-0.5 rounded bg-neutral-200 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-200">⌘T</span>
          </button>
        </div>
